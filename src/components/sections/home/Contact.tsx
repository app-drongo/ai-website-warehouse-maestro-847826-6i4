...
const DEFAULT_CONTACT = {
  ...
  mainDescription:
    'Join hundreds of logistics companies already using Warehouse Maestro to streamline their operations. Our team is ready to help you get started with a personalized demo and implementation plan.',
  formTitle: 'Request Your Free Demo',
  formDescription:
    "Tell us about your warehouse needs and we'll show you how Warehouse Maestro can optimize your operations within 30 days.",
  submitButton: 'Schedule Demo',
  contactSectionTitle: 'Speak With Our Experts',
  method1Title: 'Sales Inquiries',
  method1Description: 'Discuss pricing and features',
  method1Contact: 'sales@warehousemaestro.com',
  method2Title: 'Implementation Support',
  method2Description: 'Get help with setup and onboarding',
  method2Contact: '+1 (555) 789-0123',
  method3Title: 'Live Chat Support',
  method3Description: 'Instant help for existing customers',
  method3Contact: 'Available 6 AM - 10 PM EST',
  officesSectionTitle: 'Regional Offices',
  office1City: 'Chicago Hub',
  office1Address: '1250 Industrial Blvd, Suite 400',
  office1Timezone: 'CST (UTC-6)',
  office2City: 'Los Angeles',
  office2Address: '3400 Logistics Center Dr, Building C',
  office2Timezone: 'PST (UTC-8)',
  office3City: 'Atlanta',
  office3Address: '875 Supply Chain Way, Floor 12',
  office3Timezone: 'EST (UTC-5)',
  hoursTitle: 'Support Hours',
  hoursWeekdayLabel: 'Monday - Friday',
  hoursWeekdayTime: '6:00 AM - 10:00 PM EST',
  hoursSaturdayLabel: 'Saturday',
  hoursSaturdayTime: '8:00 AM - 6:00 PM EST',
  hoursSundayLabel: 'Sunday',
  hoursSundayTime: 'Emergency Support Only',
  supportNote: '24/7 critical system support for Enterprise customers',
  nameLabel: 'Full Name *',
  namePlaceholder: 'John Smith',
  emailLabel: 'Business Email *',
  emailPlaceholder: 'john@yourcompany.com',
  companyLabel: 'Company Name *',
  companyPlaceholder: 'Your Logistics Company',
  messageLabel: 'Tell Us About Your Warehouse *',
  messagePlaceholder:
    "Describe your current warehouse size, daily shipment volume, main challenges, and what you're looking to improve...",
} as const;
