...
const DEFAULT_HERO = {
  badge: 'New: AI-Powered Inventory Optimization',
  title: 'Transform your warehouse operations with',
  titleHighlight: 'Warehouse Maestro ERP',
  description:
    'Streamline inventory management, optimize supply chain operations, and boost productivity with our comprehensive warehouse management solution designed for growing businesses.',
  features: [
  ...
  imageAlt: 'Warehouse Maestro dashboard showing real-time inventory analytics',
  statsLabel1: 'Efficiency Boost',
  statsValue1: '40% Average',
  statsLabel2: 'Cost Reduction',
  statsValue2: '25% Savings',
} as const;
